...
exefile = "program5"
txtsolfile = "/samplesolutionp5.txt"
studentsoltxtfile = "/program5solution_student_output.txt"
cfile = "program5_lastname_firstname.c"
...
def result():
    ...
    if len(l1) == len(l2) and functools.reduce(lambda x, y : x and y, map(lambda p, q: p == q, l1, l2), True):   
        ...
        print(" \      / ")
        print("  ------  ")
        print("YES!!!! You matched the expected output.")
    else: 
        print("  ------  ")
        print(" / o  o \ ")
        print("|        |")
        ...
        print(" \      / ")
        print("  ------  ")
        print("Oh no! Your output was incorrect.") 
...
def setupchecker():
    ...
    if not os.path.exists(cwd + txtsolfile):
        ...
        " Please place the samplesolutionp5 text file in this directory and try again. Script Exiting!")
