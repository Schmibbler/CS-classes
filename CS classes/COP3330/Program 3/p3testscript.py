...
def compilerunfile():
    ...
    javac = "javac " + cwd + "/LibraryRunner.java" #compile solution file command and generate class file

    proc = subprocess.run([javac], capture_output=True, text = True, shell = True)
    

    
    java = "java LibraryRunner"
